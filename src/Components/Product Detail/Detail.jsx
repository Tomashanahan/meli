...
function Detail() {
	...
	return (
		<Box h={Object.values(product_detail)?.length > 0 && product_detail?.currency_id !== undefined ? "100%" : "100vh"}>
			{Object.values(product_detail)?.length > 0 &&
				product_detail?.currency_id !== undefined && (
					<>
						{isMobile ? (
							<>
								{showImageCarousel && (
